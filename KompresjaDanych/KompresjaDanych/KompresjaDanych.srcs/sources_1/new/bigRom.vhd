	...
	begin
		...
		then
			...
			case ENCODING_TABLE_BRAM_addr is
				...
				when x"0000_0012" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010010";
				when x"0000_0016" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010011";
				when x"0000_0020" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010100";
				when x"0000_0024" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011000";
				when x"0000_0028" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011001";
				when x"0000_0032" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011101";
				when x"0000_0036" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011110";
				when x"0000_0040" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011111";
				when x"0000_0044" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010001";
				when x"0000_0048" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010110";
				when x"0000_0052" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000010111";
				when x"0000_0056" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011011";
				when x"0000_0060" => ENCODING_TABLE_BRAM_dout <= "00000000000000000000000000011100";
	...
	begin
		...
		then
			...
			case DATA_IN_BRAM_addr is
				...
				when x"0000_0028" => DATA_IN_BRAM_dout <= "00000000000000000000000000000001";
				when x"0000_0032" => DATA_IN_BRAM_dout <= "00000000000000000000000000000001";
				when x"0000_0036" => DATA_IN_BRAM_dout <= "00000000000000000000000000000000";
				when x"0000_0040" => DATA_IN_BRAM_dout <= "00000000000000000000000000000010";
				when x"0000_0044" => DATA_IN_BRAM_dout <= "00000000000000000000000000000001";
				when x"0000_0048" => DATA_IN_BRAM_dout <= "00000000000000000000000000000010";
				when x"0000_0052" => DATA_IN_BRAM_dout <= "00000000000000000000000000000000";
