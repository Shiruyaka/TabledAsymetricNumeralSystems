...
--Command     : generate_target encoding_table_block_wrapper.bd
--Design      : encoding_table_block_wrapper
...
entity encoding_table_block_wrapper is
  port (
...
end encoding_table_block_wrapper;

architecture STRUCTURE of encoding_table_block_wrapper is
  component encoding_table_block is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component encoding_table_block;
begin
encoding_table_block_i: component encoding_table_block
     port map (
