...
CONFIG.NUM_MI {5} \
  ...
  # Create instance: data_in_mem, and set properties
  set data_in_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 data_in_mem ]
  set_property -dict [ list \
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: data_out_mem, and set properties
  set data_out_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 data_out_mem ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: encoding_table_mem, and set properties
  set encoding_table_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 encoding_table_mem ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: nb_mem, and set properties
  set nb_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 nb_mem ]
  set_property -dict [ list \
CONFIG.Enable_B {Use_ENB_Pin} \
CONFIG.Memory_Type {True_Dual_Port_RAM} \
CONFIG.Port_B_Clock {100} \
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: start_mem, and set properties
  set start_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 start_mem ]
  set_property -dict [ list \
CONFIG.Byte_Size {8} \
...
CONFIG.use_bram_block {BRAM_Controller} \
  ...
  connect_bd_intf_net -intf_net BRAM_PORTB_1 [get_bd_intf_ports START_BRAM] [get_bd_intf_pins start_mem/BRAM_PORTB]
  connect_bd_intf_net -intf_net BRAM_PORTB_1_1 [get_bd_intf_ports ENCODING_TABLE_BRAM] [get_bd_intf_pins encoding_table_mem/BRAM_PORTB]
  connect_bd_intf_net -intf_net BRAM_PORTB_2_1 [get_bd_intf_ports NB_BRAM] [get_bd_intf_pins nb_mem/BRAM_PORTB]
  connect_bd_intf_net -intf_net BRAM_PORTB_3_1 [get_bd_intf_ports DATA_IN_BRAM] [get_bd_intf_pins data_in_mem/BRAM_PORTB]
  connect_bd_intf_net -intf_net BRAM_PORTB_4_1 [get_bd_intf_ports DATA_OUT_BRAM] [get_bd_intf_pins data_out_mem/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins start_mem/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA] [get_bd_intf_pins nb_mem/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_2_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_2/BRAM_PORTA] [get_bd_intf_pins encoding_table_mem/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_3_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_3/BRAM_PORTA] [get_bd_intf_pins data_in_mem/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_4_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_4/BRAM_PORTA] [get_bd_intf_pins data_out_mem/BRAM_PORTA]
