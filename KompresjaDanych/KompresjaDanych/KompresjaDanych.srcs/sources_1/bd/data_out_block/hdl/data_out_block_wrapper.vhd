...
--Command     : generate_target data_out_block_wrapper.bd
--Design      : data_out_block_wrapper
...
entity data_out_block_wrapper is
  port (
...
end data_out_block_wrapper;

architecture STRUCTURE of data_out_block_wrapper is
  component data_out_block is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component data_out_block;
begin
data_out_block_i: component data_out_block
     port map (
