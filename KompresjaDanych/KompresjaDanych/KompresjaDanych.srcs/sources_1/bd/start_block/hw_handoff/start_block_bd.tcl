...
################################################################
# This is a generated script based on design: start_block
#
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: start_memblock, and set properties
  set start_memblock [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 start_memblock ]
  set_property -dict [ list \
...
CONFIG.use_bram_block {BRAM_Controller} \
  ...
  connect_bd_intf_net -intf_net BRAM_PORTB_1 [get_bd_intf_ports BRAM_PORTB] [get_bd_intf_pins start_memblock/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins start_memblock/BRAM_PORTA]
...
preplace port BRAM_PORTB -pg 1 -y 60 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -y 530 -defaultsOSRD
preplace inst start_memblock -pg 1 -lvl 1 -y 50 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -y 570 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 2 -y 150 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 240 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 420J 410 NJ 410 NJ 410 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 0 3 20 -120 NJ -120 790J
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 400J 420 790
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 380
preplace netloc axi_mem_intercon_M00_AXI 1 1 3 380 -110 NJ -110 1050
preplace netloc BRAM_PORTB_1 1 0 1 N
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 2 1 N
preplace netloc processing_system7_0_FIXED_IO 1 1 4 410J 430 NJ 430 NJ 430 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 430 630 770
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 340 390 440 780
levelinfo -pg 1 0 200 600 920 1070 1110 -top -430 -bot 680
",
}
