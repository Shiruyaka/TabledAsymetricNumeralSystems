...
--Command     : generate_target start_block_wrapper.bd
--Design      : start_block_wrapper
...
end start_block_wrapper;

architecture STRUCTURE of start_block_wrapper is
  ...
  end component start_block;
begin
start_block_i: component start_block
     port map (
