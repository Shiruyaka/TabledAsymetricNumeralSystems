...
HD_PWD='D:/TabledAsymetricNumeralSystems/KompresjaDanych/KompresjaDanych/KompresjaDanych.runs/nb_block_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nb_block_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nb_block_auto_pc_0.tcl
