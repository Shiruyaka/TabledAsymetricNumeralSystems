...
HD_PWD='C:/Users/tomas/OneDrive/Dokumenty/GitHub/TabledAsymetricNumeralSystems/KompresjaDanych/KompresjaDanych/KompresjaDanych.runs/start_memblock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log start_memblock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source start_memblock.tcl
