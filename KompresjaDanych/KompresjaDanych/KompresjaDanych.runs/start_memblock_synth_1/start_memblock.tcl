...
#---------------------------------------------------------
 ...
 write_checkpoint -force -noxdef -rename_prefix start_memblock_ start_memblock.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ start_memblock_stub.v
 lappend ipCachedFiles start_memblock_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ start_memblock_stub.vhdl
 lappend ipCachedFiles start_memblock_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ start_memblock_sim_netlist.v
 lappend ipCachedFiles start_memblock_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ start_memblock_sim_netlist.vhdl
 lappend ipCachedFiles start_memblock_sim_netlist.vhdl

 config_ip_cache -add -dcp start_memblock.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips start_memblock]
}

rename_ref -prefix_all start_memblock_

write_checkpoint -force -noxdef start_memblock.dcp
