...
#
# Generated by export_simulation on Thu Aug 03 23:53:59 +0200 2017
#
################################################################################
...
switch to the './start_memblock.sh' script.

./start_memblock.sh -reset_run
...
./start_memblock.sh -noclean_files

For more information on the script, please type './start_memblock.sh -help'.
