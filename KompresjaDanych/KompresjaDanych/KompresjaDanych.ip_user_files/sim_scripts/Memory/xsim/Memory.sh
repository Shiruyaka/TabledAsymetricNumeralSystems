...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_11 -L secureip -L xpm --snapshot Memory xil_defaultlib.Memory -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim Memory -key {Behavioral:sim_1:Functional:Memory} -tclbatch cmd.tcl -log simulate.log
}
