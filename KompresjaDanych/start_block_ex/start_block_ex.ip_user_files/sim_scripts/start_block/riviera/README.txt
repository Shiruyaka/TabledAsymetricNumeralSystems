...
#
# Generated by export_simulation on Thu Aug 03 23:31:05 +0200 2017
#
################################################################################
...
switch to the './start_block.sh' script.

./start_block.sh -reset_run
...
./start_block.sh -noclean_files

For more information on the script, please type './start_block.sh -help'.
